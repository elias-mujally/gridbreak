...
export type SnapshotEvent = { type: 'SNAPSHOT'; protocolVersion: typeof PROTOCOL_VERSION; buildVersion: typeof GAME_BUILD_VERSION; sequence: number; actionId?: string; room: PublicRoomState };
